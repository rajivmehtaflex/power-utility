---
name: colab-operator
description: Operate Google Colab sessions via the `colab` CLI.
---
...
PYTHONPATH="" colab new -s mysession
PYTHONPATH="" colab exec -s mysession -f script.py
```

Or set it once for the session: `export PYTHONPATH=""`
